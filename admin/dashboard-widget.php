...
function instructions_dashboard_widget()
{
	...
	<h1><a class="button" href="<?php echo admin_url( 'admin.php?page=acf-options' ); ?>">Update your organization options</a></h1>
	<h1><a class="button" href="<?php echo admin_url( 'edit.php?post_type=acf' ); ?>">Customize site forms</a></h1>
	<?php /** /<p>If you need help, please read the instructions below.</p>

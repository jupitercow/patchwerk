 ...
 */
(function() {
    tinymce.PluginManager.add('patch_magic_button', function( editor, url ) {
        editor.addButton( 'patch_magic_button', {
...
(function() {
    tinymce.PluginManager.add('patch_no_wrap', function( editor, url ) {
            editor.addButton( 'patch_no_wrap', {
            title: 'No-Wrap',
			icon: 'nonbreaking',
            onclick: function() {

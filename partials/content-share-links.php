<div class="share-links">
	...
	<?php 
		...
		$image		= apply_filters( 'patch/share_image', ($thumb_url ? $thumb_url[0] : '') );
		...
		$links = array(
			...
			array(
				'title' => 'Pinterest',
				'icon'  => 'pinterest',
				'url'   => 'https://pinterest.com/pin/create/bookmarklet/?' . ($image ? 'media='.$image.'&' : '') . 'url=' . $permalink . (apply_filters('patch/share_is_video', false) ? '&is_video=true' : '') . '&description=' . urlencode($title),
			),
		);
	?>
